...
export default class Page2 extends SINT.Container {
    ...
    constructor(game) {
        ...
        this.p1 = new SINT.SpriteClip('page2_p1');
        this.p2 = new SINT.SpriteClip('page2_p2');
        this.p3 = new SINT.SpriteClip('page2_p3');

        this.t0 = new SINT.SpriteClip('page2_t0');
        this.t1 = new SINT.SpriteClip('page2_t1');
        this.t2 = new SINT.SpriteClip('page2_t2');
        this.t3 = new SINT.SpriteClip('page2_t3');
    ...
    start() {
        ...
        this.p1.position.set(1260, 1800);
        this.p1.alpha = 0;
        ...
        this.p2.scale.set(1);
        this.p2.position.set(1000, 1870);
        this.p2.alpha = 0;
        ...
        this.p3.anchor.set(1, 0);
        this.p3.scale.set(0.7);
        this.p3.position.set(1270, 1800);
        this.p3.alpha = 0;
        ...
        this.t0.position.set(760, 920);
        this.t1.position.set(1200, 100);
        this.t2.position.set(220, 680);
        this.t3.position.set(180, 680);
